...
__all__ = ["ViT", "SimpleFeaturePyramid", "get_vit_lr_decay_rate", "SpaceToDepth", "LastLevelSPD"]
...
class LastLevelSPD(nn.Module):
    """SPD-based top block: replaces LastLevelMaxPool to preserve spatial info."""
